				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="/postlogin" method="POST">
                                ...
                                <i data-toggle="modal" data-target="#exampleModal"><button type="button" class="btn btn-danger btn-lg btn-block">SIGNUP</button></i>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Film Data Management</h1>
							<p>by Amelia.Evelyn.Waldo</p>
						</div>
					</div>
